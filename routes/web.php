...
Route::prefix('transaction')->group(function () {
    ...
    Route::get('/selldetails/{id}', [TransactionController::class, 'sellshow'])->name('transaction.sellshow');
    Route::get('/GetAllData', [TransactionController::class, 'GetAllData'])->name('checkout.transaction.GetAllData');
    Route::get('print/{id}', [TransactionController::class, 'print'])->name('checkout.transaction.print');
    ...
    Route::post('/update', [TransactionController::class, 'update'])->name('checkout.transaction.update');
    Route::post('/destroy', [TransactionController::class, 'destroy'])->name('checkout.transaction.destroy');
