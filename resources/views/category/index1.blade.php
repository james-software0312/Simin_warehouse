...
<x-modal>
    <form id="adddataform" method="POST" action="{{ route('category.store') }}">
        @csrf
        <div class="mb-3">
...
<x-edit>
    <form id="editdataform" method="POST" action="{{ route('category.update') }}">
        @csrf
...
$(function() {
    ...
    $('#EditModal').on('show.bs.modal', function(event) {
        ...
        $.ajax({
            url: 'category/' + DataId, // Replace with your actual route
            type: 'GET',
            dataType: 'json',
