...
<x-modal>
    <form id="adddataform" method="POST" action="{{ route('color.store') }}">
        @csrf
        <div class="mb-3">
...
<script type="module">
        $(function() {
            ...
            $('#EditModal').on('show.bs.modal', function(event) {
                ...
                $.ajax({
                    url: '/color/' + DataId, // Replace with your actual route
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $("#editrelatedsizes").val(data.relatedid).trigger('change');
