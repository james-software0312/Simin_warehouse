...
<div class="body-inner">
    ...
    <div class="">
        <h2 class="mb-5">{{__('text.warehouse_reports')}}</h2>
        <div class="row">
...
$(function() {
    ...
    var warehouseData = @json($warehousechart);
    var warehouseLabels = warehouseData.map(item => item.warehousename);
    var warehouseTotals = warehouseData.map(item => item.total);
    ...
    var tabledatareport = $('#data').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{!! route('reports.getwarehousereport') !!}',
