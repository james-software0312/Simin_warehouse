@extends('layouts.app')
@section('title', __('text.selling_price_history'))
...
<div class="body-inner">
    ...
    <ul class="nav nav-tabs mb-3">
        ...
        @if($isCheckOut)
        <li class="nav-item">
            <a href="{{route('stock.sellpricehistory', ['id' => $stockitemid])}}" class="nav-link active" href="#" tabindex="-1" aria-disabled="true">{{__('text.selling_price_history')}}</a>
        </li>
        @endif
        @if($isCheckIn)
        <li class="nav-item">
...
$(function() {
    $('#data').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{!! route('transaction.getsellpricehistory') !!}?stockitemid={{ $stockitemid }}",
