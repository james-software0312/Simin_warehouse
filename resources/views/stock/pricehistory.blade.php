...
<div class="body-inner">
    ...
    <ul class="nav nav-tabs mb-3">
        ...
        @endif
        <li class="nav-item">
            <a href="{{route('stock.pricehistory', ['id' => $data->id])}}" class="nav-link active" href="#" tabindex="-1" aria-disabled="true">{{__('text.price_history')}}</a>
        </li>
    </ul>
...
$(function() {
    $('#data').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{!! route('stock.getpricehistory') !!}?stockitemid={{ $stockitemid }}",
