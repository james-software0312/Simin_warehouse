...
<div class="body-inner">
    ...
    <div class="">
        ...
        <form id="editdataform" method="POST" action="{{ route('size.update') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="editid" id="editid" value="{{$data->id}}">
                <div class="row">
                    <div class="col-md-12 row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="description" class="form-label">{{__('text.size')}}</label>    
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{route('size.index')}}" class="btn btn-danger d-flex align-items-center">
