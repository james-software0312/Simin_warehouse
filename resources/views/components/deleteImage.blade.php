<div class="modal fade" id="DeleteImageModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
    <!-- Modal content -->
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary d-flex align-items-center" id="modalDeleteImageButton">
