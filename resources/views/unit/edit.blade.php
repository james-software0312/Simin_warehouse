...
<div class="body-inner">
    ...
    <div class="">
        ...
        <form id="editdataform" method="POST" action="{{ route('unit.update') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="editid" id="editid" value="{{$data->id}}">
                <div class="row">
                    <div class="col-md-12 row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="description" class="form-label">{{__('text.code')}}</label>    
                                <input type="text" class="form-control" id="editprice" name="name" required min="0" max="100" value="{{$data->code}}" >
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="description" class="form-label">{{__('text.name')}}</label>    
                    ...
                    <div class="col-md-12 row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea value="{{$data->description}}"  style="height: 200px;" rows="5" id="editdescription" class="form-control" name="description" placeholder="{{__('text.description')}}">{{$data->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <a href="{{route('unit.index')}}" class="btn btn-danger d-flex align-items-center">
